...
class AlbumArt(Widget):
    """Renders the album art image as grayscale ASCII characters colored by the theme."""
    ...
    def render(self) -> str:
        ...
        try:
            ...
            # Width and height of our display
            w, h = 32, 12
            img = img.resize((w, h))
            
            # Grayscale character density map
            ascii_chars = " .:-=+*#%@"
...
class PlayerPane(Widget):
    ...
    track_title = reactive("Wanna Love You Anymore")
    track_artist = reactive("LANY")
    track_album = reactive("Malibu Nights")
    ...
    def update_progress_ui(self):
        ...
        rem_seconds = self.track_duration - self.track_current_time
